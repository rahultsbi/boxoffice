...
function MainAppPage({ user, onLogout, onTokenExpired }) {
  ...
  const getStepDisplayName = (stepName, isMandatory = false) => {
    let displayName;
    switch(stepName) {
        ...
        <div className="w-1/2 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600">Fill in the details to predict box office performance</p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {steps.map((stepName, index) => {
                  ...
                  return (
                    <div key={stepName} className={`rounded-xl p-5 border transition-colors duration-200 mb-4 ${
                      isOptional 
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                          ...
                          {formData[stepName] ? '✓' : isOptional ? '?' : index + 1}
                        </div>
