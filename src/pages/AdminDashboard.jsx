...
//                     <p className="text-2xl font-bold text-gray-900">{adminStats.users.active}</p>
//                   </div>
//                 </div>
//               </div>
...
//                     <p className="text-2xl font-bold text-gray-900">{adminStats.predictions.total}</p>
//                   </div>
//                 </div>
//               </div>
...
//                     <p className="text-2xl font-bold text-gray-900">{adminStats.predictions.recent}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//                     <li>• {adminStats.users.recent_new} new users in last 30 days</li>
//                     <li>• {adminStats.users.active} active users total</li>
//                     <li>• {((adminStats.users.active / adminStats.users.total) * 100).toFixed(1)}% user activity rate</li>
//                   </ul>
//                 </div>
//                 <div>
//                   <h4 className="font-medium text-gray-900 mb-2">Prediction Activity</h4>
//                   <ul className="space-y-2 text-sm text-gray-600">
//                     <li>• {adminStats.predictions.recent} predictions in last 30 days</li>
//                     <li>• {(adminStats.predictions.total / adminStats.users.total).toFixed(1)} avg predictions per user</li>
//                     <li>• {adminStats.predictions.total} total predictions made</li>
//                   </ul>
//                 </div>
//               </div>
//             </div>
...
//                             <div className="flex items-center">
//                               <span className="mr-2">{userItem.predictions_count}</span>
//                               {userItem.predictions_count > 0 && (
...
//                                 <>
//                                   <span className="mr-1">🔽</span>
//                                   View Predictions ({userItem.predictions_count})
//                                 </>
//                               )}
//                             </button>
//                           </td>
...
//                                     🎬 Predictions for {userPredictions.user.username}
//                                   </h4>
//                                   <span className="text-sm text-gray-500">
//                                     {userPredictions.predictions.length} total predictions
//                                   </span>
//                                 </div>
...
//                                               {formatCurrency(pred.prediction.predicted_revenue || 0)}
//                                             </div>
//                                             <div className="text-sm text-gray-500">
//                                               {Math.round((pred.prediction.confidence || 0) * 100)}% confidence
//                                             </div>
                                        ...
                                        <div className="pt-3 border-t border-gray-100">
                                          <div className="grid grid-cols-2 md:grid-cols-6 gap-3 text-xs">
                                            ...
                                            <div>
                                              ...
                                              <br />
                                              <span className="text-gray-700">
                                                {pred.prediction?.dataSource || 'ML Model'}
                                              </span>
                                            </div>
                                            <div>
                                              <span className="text-gray-500">Created:</span>
